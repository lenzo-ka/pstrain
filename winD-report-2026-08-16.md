...
- Released the feature configuration, output and dump model definitions, dictionaries, global command-line configuration, and optional tied-state range file in `kmeans_init`. Recoverable initialization failures now release partially constructed objects as well.
